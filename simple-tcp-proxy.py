...
def receive_from(connection):
    ...
    # We set 2 sencond timeout; depending on your target, this may need to be adjusted
...
# modify and responses destined for the local host
...
def main():
    ...
    if len(sys.argv[1:]) != 5:
        print "Usage: python simple-tcp-proxy.py [localhost] [localport] [remotehost] [remoteport] [receive_first]"
        print "Example: python simple-tcp-proxy.py 127.0.0.1 9000 10.12.132.1 9000 True"
        sys.exit(0)
